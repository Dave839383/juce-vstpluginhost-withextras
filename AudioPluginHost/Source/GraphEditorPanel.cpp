      ...
      graphPlayer (getAppProperties().getUserSettings()->getBoolValue ("doublePrecisionProcessing", false))
{
    ...
    // midiMessageCollector class listens for noteon/noteoff events from keystate.
    ...
    addAndMakeVisible (playbackComponent = new PlaybackComponent(graphPlayer));
...
void GraphDocumentComponent::resized()
{
    ...
    playbackComponent->setBounds(getWidth() - 280, getHeight() - 140, 200, 20);
}
